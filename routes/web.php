...
Route::middleware('auth')->group(function () {
    ...
    */
    Route::prefix('employee')->group(function () {
        ...
        Route::view('/', 'employee.index')->name('employee');

        Route::view('/create', 'employee.create')
        ...
        |--------------------------------------------------------------------------
        */
        Route::view('/fsi', 'employee.fsi');

        Route::view('/fsi/create', 'employee.fsi-create');
        ...
        |--------------------------------------------------------------------------
        */
        Route::view('/isti', 'employee.isti');

        Route::view('/isti/create', 'employee.isti-create');
...
Route::resource('employees', EmployeeController::class);
    ...
    |--------------------------------------------------------------------------
    */
    Route::prefix('pkwt')->group(function () {

        Route::view('/', 'pkwt.index')->name('pkwt');

        Route::view('/fsi', 'pkwt.fsi');

        Route::view('/isti', 'pkwt.isti');
...
Route::post('/employee/{id}/inline-update', [SeeDetailController::class, 'inlineUpdate'])
    ->name('employee.inlineUpdate');

Route::get('/pkwt/fsi', [PkwtController::class, 'index'])->name('pkwt.fsi');
